<template>
  <div class="m-activity_details">
          ...
          <div class="zuoyou-right">
            <div v-for="(item, index) in userinfo.shoushuzizhiList" :key="'shoushuzizhiList'+index" class="right-line">
              <div class="bx bx-5 bx-time">
                ...
                <span class="u-otherbox"><span class="u-otherspan">其他:</span><input v-model="item.other" type="text" class="u-otherinput" style="width: 180px;"></span>
              </div>
    ...
    <div style="text-align: center;">
      <el-button v-loading.fullscreen.lock="fullscreenLoading" type="primary" style="margin-right: 40px;min-width: 120px;" @click="userEdit">确定</el-button>
